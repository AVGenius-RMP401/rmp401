...
namespace robot
{
    class Chassis
    {
        ...
        private:
            ...
            {
                RCLCPP_INFO(rclcpp::get_logger("RMP401"), "Receive goal request with iap_board %d", goal->iap_board);
                (void)uuid;
            ...
            {
                RCLCPP_INFO(rclcpp::get_logger("RMP401"), "Received request to cancel goal");
                (void)goal_handle;
